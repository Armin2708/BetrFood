...
-- ============================================================
-- 17. Recommendation System: Interaction Tracking
-- ============================================================

-- Add timestamps to likes table (for interaction analytics)
ALTER TABLE likes ADD COLUMN IF NOT EXISTS created_at TIMESTAMPTZ DEFAULT now();
CREATE INDEX IF NOT EXISTS idx_likes_created_at ON likes(created_at DESC);

-- ============================================================
-- 18. Post Impressions (View Tracking)
-- ============================================================
...
-- ============================================================
-- 19. Post Negative Feedback (Not Interested)
-- ============================================================
...
-- ============================================================
-- 20. User Preference Vectors (Recommendation Engine)
-- ============================================================
