...
function renderAssistantContent(content: string, colors: ThemeColors, scaledTypography: ReturnType<typeof useScaledTypography>) {
  const mdStyles = makeMarkdownStyles(colors, scaledTypography);
  const sheetStyles = makeStyles(colors, scaledTypography);
...
export default function AssistantChatScreen({
        ...
        {isUser ? (
          ...
          <View style={styles.assistantMessageWrap}>
            ...
            <View style={styles.assistantBody}>
              <View style={styles.assistantBubble}>{renderAssistantContent(item.content, colors, scaledTypography)}</View>
  ...
  }, [handleCopy, scaledTypography, colors, styles]);
          ...
          <View style={styles.flex}>
            ...
            {streamingContent && streamingContent.length > 0 ? (
              <View style={styles.typingRow}>
                ...
                <View style={styles.streamingBubble}>{renderAssistantContent(streamingContent, colors, scaledTypography)}</View>
              </View>
            ) : null}
          </View>
...
function makeMarkdownStyles(colors: ThemeColors, scaledTypography: ReturnType<typeof useScaledTypography>) {
